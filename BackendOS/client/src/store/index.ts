...
const defaultApps: AppDefinition[] = [
  ...
  { id: 'file-manager', name: 'Files', icon: '📁', defaultWidth: 750, defaultHeight: 500, minWidth: 400, minHeight: 300, component: 'FileManager' },
  { id: 'text-editor', name: 'Editor', icon: '📝', defaultWidth: 800, defaultHeight: 550, minWidth: 400, minHeight: 300, component: 'TextEditor' },
  { id: 'settings', name: 'Settings', icon: '⚙️', defaultWidth: 650, defaultHeight: 480, component: 'Settings' },
  { id: 'system-monitor', name: 'System Monitor', icon: '📊', defaultWidth: 500, defaultHeight: 400, component: 'SystemMonitor' },
...
export const useDesktopStore = create<DesktopStore>((set) => ({
  ...
  setDockPosition: (dockPosition) => set((s) => ({ settings: { ...s.settings, dockPosition } })),
  setDockAutoHide: (dockAutoHide) => set((s) => ({ settings: { ...s.settings, dockAutoHide } })),
}));
